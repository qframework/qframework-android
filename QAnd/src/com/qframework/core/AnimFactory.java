...
public class AnimFactory {
    ...
    private void processAnimFrame(GL10 gl, JSONObject objData , AnimFrame frame) {
    	int count = 0;
    	try {
...
//public members	
	...
	public void process(GL10 gl, long framedelta)
	{
	...
	public void initAnimation(GL10 gl, JSONObject response)
    {
        // init layout
		try {
